...
// ==================== AUDIO GENERATION DENGAN VOICE STABIL ====================
async function generateAudio(text, useMaleVoice = false) {
    ...
    try {
        // VOICE STABIL - Setting tetap konsisten seperti manusia
        const voiceSettings = {
            stability: 0.75,        // Tinggi agar suara stabil
            similarity_boost: 0.75,  // Konsisten dengan suara asli
            style: 0.0,              // Netral, tidak ada efek berlebihan
            speed: 1.0,               // Kecepatan normal seperti manusia
            use_speaker_boost: true   // Suara lebih jelas
        };
